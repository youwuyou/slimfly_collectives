...
extern const mca_base_component_t mca_state_dvm_component;
...
extern const mca_base_component_t mca_state_staged_hnp_component;
extern const mca_base_component_t mca_state_staged_orted_component;
