...
export SRCDIR=/scratch/dphpc/ompi1-dev/openmpi/ompi/contrib/vt/vt/config/mpigen
...
outprefix=/scratch/dphpc/ompi1-dev/openmpi/ompi/contrib/vt/vt/vtlib/vt_mpireg.gen
tmp=tmp$$
