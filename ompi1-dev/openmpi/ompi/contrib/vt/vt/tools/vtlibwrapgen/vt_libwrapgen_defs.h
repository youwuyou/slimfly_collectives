...
#define VT_LIBWRAPGEN_DEFAULT_CC                "/scratch/dphpc/spack/lib/spack/env/gcc/gcc"
#define VT_LIBWRAPGEN_DEFAULT_CPP               "/scratch/dphpc/spack/lib/spack/env/gcc/gcc -E"
#define VT_LIBWRAPGEN_DEFAULT_CFLAGS            "-g -O2"
