...
/* Define to 1 if you have the declaration of `ibv_cmd_open_xrcd', and to 0 if
   you don't. */
#define HAVE_DECL_IBV_CMD_OPEN_XRCD 0
...
#define MCA_hwloc_external_header "/scratch/dphpc/spack/opt/spack/linux-centos7-sandybridge/gcc-12.2.0/hwloc-1.11.13-3yetns36nwzcusjrx5t2sjpi7srgyjas/include/hwloc.h"

/* Location of external hwloc header */
#define MCA_hwloc_external_openfabrics_header "/scratch/dphpc/spack/opt/spack/linux-centos7-sandybridge/gcc-12.2.0/hwloc-1.11.13-3yetns36nwzcusjrx5t2sjpi7srgyjas/include/hwloc/openfabrics-verbs.h"

/* Complete set of command line arguments given to ROMIOs configure script */
#define MCA_io_romio_COMPLETE_CONFIGURE_FLAGS " FROM_OMPI=yes CC='/scratch/dphpc/spack/lib/spack/env/gcc/gcc' CFLAGS='-O3 -DNDEBUG -finline-functions -fno-strict-aliasing -pthread' CPPFLAGS='   -I/scratch/dphpc/spack/opt/spack/linux-centos7-sandybridge/gcc-12.2.0/hwloc-1.11.13-3yetns36nwzcusjrx5t2sjpi7srgyjas/include -I/scratch/dphpc/ompi1-dev/openmpi/opal/mca/event/libevent2021/libevent -I/scratch/dphpc/ompi1-dev/openmpi/opal/mca/event/libevent2021/libevent/include' FFLAGS='' LDFLAGS='   -L/scratch/dphpc/spack/opt/spack/linux-centos7-sandybridge/gcc-12.2.0/hwloc-1.11.13-3yetns36nwzcusjrx5t2sjpi7srgyjas/lib' --enable-shared --enable-static  --prefix=/scratch/dphpc/spack/opt/spack/linux-centos7-sandybridge/gcc-12.2.0/openmpi-1.10.7-p5fattu4nnmmlh2d3bvug2soz455gvjh --disable-aio"
...
#define OMPI_CXX "/scratch/dphpc/spack/lib/spack/env/gcc/g++"
...
#define OMPI_FC "/scratch/dphpc/spack/lib/spack/env/gcc/gfortran"

/* Absolutey path to the underlying Fortran compiler found by configure */
#define OMPI_FC_ABSOLUTE ""
...
/* The compiler $lower which OMPI was built with */
#define OPAL_BUILD_PLATFORM_COMPILER_VERSION 786944

/* The compiler $lower which OMPI was built with */
#define OPAL_BUILD_PLATFORM_COMPILER_VERSION_STR 12.2.0

/* OMPI underlying C compiler */
#define OPAL_CC "/scratch/dphpc/spack/lib/spack/env/gcc/gcc"
...
#define OPAL_CXX "/scratch/dphpc/spack/lib/spack/env/gcc/g++"
...
#define OPAL_HAVE_JAVA_SUPPORT 0
...
#define OPAL_PACKAGE_STRING "Open MPI dphpc@slimflysmw Distribution"
